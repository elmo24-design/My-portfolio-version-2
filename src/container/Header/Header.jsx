        ...
        >
          <div className="app__header-heading">
            ...
            <p className="heading-desc-2">
              A Fullstack developer from Pililla, Rizal, Philippines. I craft
              creative and engaging Web Apps
            </p>
          </div>
        ...
        >
          ...
          >
            <div className="circle-container circle-container-1">
              ...
              <div className="white-box">UI Designer</div>
            </div>
            <div className="circle-container circle-container-2">
              ...
              <div className="white-box">Developer</div>
            </div>
          </motion.div>
          {/* <motion.img

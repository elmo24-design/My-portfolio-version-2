      ...
      <div className="app__profiles">
        ...
        <div class="right-about-grid">
            ...
            <p>I love coding and formulating logics to solve problems with the use of Web Technologies.
               I specialize mostly in Javascript, and MERN Stack development.
            </p>
            <p class="p-2">
              My journey started back in May, 2020, some time after the school lockdown began due to the pandemic. 
              I was an incoming third year college at that time when I started to get curious about how the web works.  
              Since then, I started to self-study about web development and eventually fell inlove with it.
            </p>
